...
static const char *const g_Zvc_Strings[] =
    {
        "Ver Edit (&1)", "Ver Commit", "Ver Revert", "Ver Diff (&0)"};
...
bool ExecuteFileCommand(unsigned id)
{
  ...
  case IDM_OPEN_INSIDE:
    g_App.OpenItemInside(NULL);
    break;
  case IDM_OPEN_INSIDE_ONE:
    g_App.OpenItemInside(L"*");
    break;
  case IDM_OPEN_INSIDE_PARSER:
    g_App.OpenItemInside(L"#");
    break;
  ...
  case IDM_MOVE_TO:
    ...
    break;
  case IDM_DELETE:
    g_App.Delete(!IsKeyDown(VK_SHIFT));
    break;
  ...
  case IDM_HASH_ALL:
    ...
    break;
  case IDM_CRC32:
    g_App.CalculateCrc("CRC32");
    break;
  case IDM_CRC64:
    g_App.CalculateCrc("CRC64");
    break;
  case IDM_XXH32:
    g_App.CalculateCrc("XXH32");
    break;
  case IDM_XXH64:
    g_App.CalculateCrc("XXH64");
    break;
  case IDM_MD2:
    g_App.CalculateCrc("MD2");
    break;
  case IDM_MD4:
    g_App.CalculateCrc("MD4");
    break;
  case IDM_MD5:
    g_App.CalculateCrc("MD5");
    break;
  case IDM_SHA1:
    g_App.CalculateCrc("SHA1");
    break;
  case IDM_SHA2_256:
    g_App.CalculateCrc("SHA256");
    break;
  case IDM_SHA2_384:
    g_App.CalculateCrc("SHA384");
    break;
  case IDM_SHA2_512:
    g_App.CalculateCrc("SHA512");
    break;
  case IDM_BLAKE2sp:
    g_App.CalculateCrc("BLAKE2sp");
    break;
  case IDM_BLAKE3:
    g_App.CalculateCrc("BLAKE3");
    break;
  case IDM_SHA3_256:
    g_App.CalculateCrc("SHA3-256");
    break;
  case IDM_SHA3_384:
    g_App.CalculateCrc("SHA3-384");
    break;
  case IDM_SHA3_512:
    g_App.CalculateCrc("SHA3-512");
    break;
  ...
  case IDM_LINK:
    g_App.Link();
    break;
  case IDM_ALT_STREAMS:
    g_App.OpenAltStreams();
    break;
#endif
  default:
    return false;
...
bool OnMenuCommand(HWND hWnd, unsigned id)
{
  ...
  */
  ...
  case IDM_VIEW_REFRESH:
    g_App.RefreshView();
    break;
  case IDM_VIEW_AUTO_REFRESH:
    g_App.Change_AutoRefresh_Mode();
    break;
