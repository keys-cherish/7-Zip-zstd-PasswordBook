...
# 7-Zip ZS with Password Book / 7-Zip ZS 密码本增强版
...
This is a fork of [mcmilk/7-Zip-zstd](https://github.com/mcmilk/7-Zip-zstd) with an additional **Password Book** feature, similar to Bandizip's password manager.

### New Feature: Password Book

A password manager integrated into 7-Zip that allows you to:

- **Save passwords** with custom display names
- **Quick select** passwords from dropdown menu in compress/extract dialogs
- **Import/Export** passwords for backup and transfer
- **Manage passwords**: Add, Edit, Delete, Move Up/Down
- **Double-click** to copy password to clipboard

#### Access Methods

The Password Book can be accessed from:
- **Tools Menu** → Password Book
- **Compress Dialog** → Dropdown button next to password field
- **Extract Dialog** → Dropdown button next to password field
...
- **[7-Zip](https://www.7-zip.org/)** by Igor Pavlov - The original 7-Zip
- **[7-Zip-zstd](https://github.com/mcmilk/7-Zip-zstd)** by Tino Reichardt (mcmilk) - 7-Zip with Zstandard and other codec support

### License

Same as the upstream projects:
- **GNU LGPL version 2.1 or later** for most of the code
- See [COPYING](COPYING) for full license details
...
- **English version** - Default UI language
- **Chinese version** - With zh-cn.txt language file

### Credits

- Igor Pavlov - 7-Zip
- Tino Reichardt (mcmilk) - 7-Zip-zstd
- Password Book feature added by this fork
...
这是 [mcmilk/7-Zip-zstd](https://github.com/mcmilk/7-Zip-zstd) 的一个分支，增加了**密码本**功能，类似于 Bandizip 的密码管理器。

### 新功能：密码本 (Password Book)

集成到 7-Zip 中的密码管理器，功能包括：

- **保存密码** - 可以为每个密码设置自定义显示名称
- **快速选择** - 在压缩/解压对话框中通过下拉菜单快速选择密码
- **导入/导出** - 支持密码的备份和迁移
- **密码管理** - 添加、编辑、删除、上移/下移
- **双击复制** - 双击密码即可复制到剪贴板
...
本项目基于：
- **[7-Zip](https://www.7-zip.org/)** - Igor Pavlov 开发的原版 7-Zip
- **[7-Zip-zstd](https://github.com/mcmilk/7-Zip-zstd)** - Tino Reichardt (mcmilk) 开发的支持 Zstandard 等编码器的 7-Zip

### 许可证

与上游项目相同：
- 大部分代码使用 **GNU LGPL 2.1 或更高版本**
...
请查看 [Releases](../../releases) 获取预编译版本：
- **英文版** - 默认 UI 语言
- **中文版** - 包含 zh-cn.txt 语言文件

### 致谢

- Igor Pavlov - 7-Zip 原作者
- Tino Reichardt (mcmilk) - 7-Zip-zstd 作者
- 密码本功能由本分支添加

---

# Original 7-Zip-zstd README
